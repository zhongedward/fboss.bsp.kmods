...
#define DRIVER_NAME	"mp3n_fancpld"

/*
 * Total 8 fan trays. Each fan LED supports 2 colors.
 */
...
/* MCBCPLD_FAN id */
static const struct i2c_device_id mp3n_fancpld_i2c_id[] = {
	{ DRIVER_NAME, 0 },
	{ },
};
...
static struct i2c_driver mp3n_fancpld_i2c_driver = {
	...
	.id_table = mp3n_fancpld_i2c_id,
};

module_i2c_driver(mp3n_fancpld_i2c_driver);

MODULE_AUTHOR("Brandon Chuang <brandon_chuang@accton.com>");
MODULE_DESCRIPTION("Meta FBOSS Minipack3n MCBCPLD (FAN) Driver");
MODULE_LICENSE("GPL");
