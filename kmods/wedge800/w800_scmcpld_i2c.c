...
#define DRIVER_NAME	"w800_scmcpld"
...
static const struct i2c_device_id w800_scmcpld_id[] = {
	{ DRIVER_NAME, 0 },
	{ },
};
MODULE_DEVICE_TABLE(i2c, w800_scmcpld_id);
...
static struct i2c_driver w800_scmcpld_driver = {
	...
	.id_table = w800_scmcpld_id,
};
module_i2c_driver(w800_scmcpld_driver);

MODULE_AUTHOR("Tao Ren <taoren@meta.com>");
MODULE_DESCRIPTION("Meta FBOSS Wedge800 SCM CPLD Driver");
MODULE_LICENSE("GPL");
